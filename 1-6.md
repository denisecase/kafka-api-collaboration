...
Ans:  In simple code there is one consumer app "consumer.java" and four producer apps "producer.java", "producerHello.java", "producerSentence.java"and "producerSentenceRandom.java". In partion code we have consumer app "consumer.java" and producer app "producer.java" and partion app "CountryPartion.java".
