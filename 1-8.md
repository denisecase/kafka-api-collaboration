...
Ans: I have looked into cunsumer.java and this will take the messages from the producer and this files consists of logic related to it.
*The classes used are : custom consumer and consumerThread classes
*The methods are: start and run methods
