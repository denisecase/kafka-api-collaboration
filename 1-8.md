...
Ans: Renaming a topic is not a supported operation. However, the latest Kafka versions now support topic deletion. So we can simply delete the old topic, and create a new one with the new name.
