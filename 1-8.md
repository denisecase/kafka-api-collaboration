...
Ans:In ProducerHello.java we will give the topic name, it will print the topic name and hello if message is equal to hello till 10 times and till line not equal to exit it will be get printed. If line is equal to exit the message wont be displayed.In produce.java the topic name and message wont be displayed. 
